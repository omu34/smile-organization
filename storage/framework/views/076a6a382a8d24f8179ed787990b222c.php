        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <main class="w-full lg:w-2/3 xl:w-3/4">
                ...
                <div class="mb-4 flex items-center space-x-2">
                    ...
                    <span class="text-sm text-gray-500 font-medium"><?php echo e(now()->format('F j, Y')); ?></span>
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->primaryMedia): ?>
                    ...
                    <div class="mb-10 w-full overflow-hidden bg-gray-100 rounded-xl shadow-sm border border-gray-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($m->type === 'image'): ?>
                            <img src="<?php echo e(asset('storage/' . $m->file_path)); ?>" class="w-full h-auto object-cover max-h-[600px] hover:opacity-95 transition-opacity" alt="<?php echo e($article->title); ?>">
                        ...
                        <?php elseif($m->type === 'youtube' && $m->youtube_id): ?>
                            <div class="relative w-full" style="padding-top: 56.25%;">
                                <iframe class="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/<?php echo e($m->youtube_id); ?>" frameborder="0" allowfullscreen></iframe>
                            </div>
...
<?php echo $__env->make('components.layouts.pages-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\projects\smile-organization\resources\views\articles\show.blade.php ENDPATH**/ ?>