    ...
    <div class="space-y-4">
        ...
        <div id="chat-log" class="space-y-4 max-h-[380px] overflow-y-auto p-4 bg-gray-50/70 rounded-xl border border-gray-100 scroll-smooth">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex <?php echo e($m['role'] === 'user' ? 'justify-end' : 'justify-start'); ?>">
                    <div class="max-w-[85%] px-4 py-3 rounded-2xl text-sm leading-relaxed shadow-sm <?php echo e($m['role'] === 'user' ? 'bg-red-600 text-white rounded-tr-xs' : 'bg-white text-gray-900 border border-gray-200 rounded-tl-xs'); ?>">
...
</div><?php /**PATH F:\projects\smile-organization\resources\views\livewire\chat\chat-component.blade.php ENDPATH**/ ?>