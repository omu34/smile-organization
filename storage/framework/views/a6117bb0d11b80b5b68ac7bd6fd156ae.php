...
>
    ...
    >
        <!--[if BLOCK]><![endif]--><?php if($hasFiltersBeforeContent): ?>
            <div
...
<?php endif; ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($hasCollapsibleFilters): ?>
                            <span
...
<?php endif; ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($isGlobalSearchVisible || $hasFiltersTrigger || $hasColumnManagerDropdown): ?>
                        <div>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($hasFiltersTrigger || $hasColumnManagerDropdown): ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(((! $content) && (! $hasColumnsLayout)) || ($records === null) || count($records)): ?>
                ...
                >
                    <!--[if BLOCK]><![endif]--><?php if($hasContentLayout && ($records !== null) && count($records)): ?>
                        <!--[if BLOCK]><![endif]--><?php if(! $isReordering): ?>
                            <?php
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($hasEmptyState): ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($hasPagination): ?>
                <?php
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($hasFiltersAfterContent): ?>
            <div
                x-ref="filtersContentContainer"
                x-transition:enter-start="fi-opacity-0"
                x-transition:leave-end="fi-opacity-0"
...
<?php /**PATH C:\Users\Rygss\Downloads\smile-organization\vendor\filament\tables\resources\views/index.blade.php ENDPATH**/ ?>