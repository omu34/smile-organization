<div class="pt-20 pb-10"
    ...
    <div class="mx-auto px-5">
        ...
        <div key="<?php echo e($categoryFilter); ?>">
            <?php $__empty_1 = true; $__currentLoopData = $groupedGalleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div x-show="open" x-cloak
        ...
        <?php if($selectedGallery): ?>
            <div class="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-2xl max-w-4xl w-full mx-5 relative"
                ...
                <?php if(array_search($this->selectedGalleryId, $this->galleryIds) > 0): ?>
...
</div><?php /**PATH C:\Users\Rygss\Downloads\smile-organization\resources\views\livewire\gallery-section.blade.php ENDPATH**/ ?>