<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="swiper-wrapper">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $slider->slides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide bg-cover bg-no-repeat bg-center relative flex items-center justify-center lazy-bg"
                        data-bg="<?php echo e($slide->full_image_url); ?>"
                        ...
                        <div class="relative z-10 p-6 md:p-12 text-center text-white max-w-3xl mx-auto flex flex-col items-center">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slide->description): ?>
                                <p class="text-gray-200 text-base md:text-lg mb-8 max-w-2xl leading-relaxed font-normal">
                                    <?php echo e(Str::limit($slide->description, 120)); ?>
    ...
    <?php else: ?>
        <div class="w-full py-16 bg-gray-50 rounded-2xl border border-gray-100 flex items-center justify-center text-gray-500 shadow-sm">
            <p class="font-medium">No slider found for slug: <strong class="text-gray-900"><?php echo e($slug); ?></strong></p>
        </div>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div><?php /**PATH F:\projects\smile-organization\resources\views\livewire\slider-show.blade.php ENDPATH**/ ?>