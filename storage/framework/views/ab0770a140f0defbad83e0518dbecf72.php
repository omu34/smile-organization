<div class="pt-20 pb-10" x-data="{ open: false }" x-on:show-modal.window="open = true"
    ...
    <!--[if BLOCK]><![endif]--><?php if($selectedGallery): ?>
        <div x-show="open" x-cloak class="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50"
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-2xl max-w-4xl w-full mx-5 relative"
                ...
                <div class="p-4 text-center">
                    ...
                    <p class="text-black"><?php echo e($selectedGallery->category); ?></p>
                </div>
...
<?php /**PATH C:\Users\Rygss\Downloads\smile-organization\resources\views/livewire/gallery-section.blade.php ENDPATH**/ ?>