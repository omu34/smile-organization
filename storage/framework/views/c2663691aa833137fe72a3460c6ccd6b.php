...
$__html = app('livewire')->mount($__name, $__params, 'lw-1063747434-1', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <nav class="hidden md:flex space-x-2 items-center">
                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($menu->items && $menu->items->count()): ?>
                            ...
                            <div class="relative" x-data="{ open: false }" @mouseleave="open = false">
                                <?php if($item->children->count()): ?>
                                    ...
                                    <div x-show="open" x-cloak x-transition
                                        ...
                                        <div class="py-2">
                                            <?php $__currentLoopData = $item->children->where('is_active', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH C:\Users\Rygss\Downloads\smile-organization\resources\views\livewire\dynamic-navbar.blade.php ENDPATH**/ ?>