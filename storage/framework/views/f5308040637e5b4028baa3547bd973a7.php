    ...
    <div class="py-16 pb-14 mx-auto" id="beneficiaries">
        <div class="  px-5">
            ...
            <div class="flex flex-wrap -mx-4 mt-10">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $beneficiaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\Rygss\Downloads\smile-organization - Copy\resources\views/livewire/beneficiary-section.blade.php ENDPATH**/ ?>