<div class="p-4 bg-white rounded shadow">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('message')): ?>
        <div class="p-2 bg-green-100 rounded mb-2"><?php echo e(session('message')); ?></div>
...
<?php /**PATH F:\projects\smile-organization\resources\views\livewire\ai\image-edit-uploader.blade.php ENDPATH**/ ?>