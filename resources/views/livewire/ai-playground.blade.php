                    ...
                    <div class="space-y-5 flex-grow">
                        ...
                        @if ($textResult)
                            <div class="mt-4 bg-gray-50 border-l-4 border-red-600 p-5 rounded-r-lg shadow-inner">
                                ...
                                <p class="text-gray-800 whitespace-pre-wrap leading-relaxed">{!! nl2br(e($textResult)) !!}</p>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-5 flex-grow">
                        ...
                        @if ($generatedImage)
                            <div class="mt-4 rounded-lg overflow-hidden border border-gray-200 shadow-sm bg-gray-100 aspect-square">
                                <img src="{{ $generatedImage }}" class="w-full h-full object-cover" alt="Generated AI Image" />
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="space-y-5 flex-grow">
                        ...
                        @if ($uploadedImage)
                            <div class="rounded-lg overflow-hidden border border-gray-200 shadow-sm bg-gray-100 aspect-video">
                                <img src="{{ $uploadedImage->temporaryUrl() }}" class="w-full h-full object-cover">
                            </div>
                        @endif
