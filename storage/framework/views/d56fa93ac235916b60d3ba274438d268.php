    ...
    <section class="pt-20 pb-5 mx-auto " id="our-resources">
        <div class="w-full px-4">
            ...
            <section class="w-full mx-auto py-10 bg-white rounded-xl  space-y-12">
                <?php $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $resource): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        ...
                        <div class="w-full md:w-1/2 bg-white text-left">
                            ...
                            <?php if($resource->extra_description): ?>
...
</div><?php /**PATH C:\Users\Rygss\Downloads\smile-organization\resources\views\livewire\resource-section.blade.php ENDPATH**/ ?>