<div class="container mx-auto px-4 py-8">
    ...
    @if ($areaTitle)
            <div class="flex justify-start -mb-8 md:justify-center items-center flex-col md:py-2">
                <h2
    ...
    <div class="area-carousel-wrapper h-[200px] md:h-[400px] lg:h-[600px] relative">
        ...
        <div class="area-carousel w-full h-full relative">
            @forelse ($areas_of_practices as $index => $area)
                ...
                @endphp
                <div class="area-carousel-item w-[90px] sm:w-[190px] lg:w-[250px] h-[120px] sm:h-[190px] lg:h-[250px] transition-transform duration-300"
                    style="--rotateY: {{ $angle }}deg">
                    <div
                        class="bg-gray-50 hover:bg-gray-300 hover:text-white rounded shadow-md p-4 text-center transform transition-transform duration-300 hover:scale-105">
                        ...
                        <img src="{{ $area->full_image_path }}" alt="{{ $area->subtitle }}"
                            class="mt-2 rounded w-full h-auto lazyload"
                            loading="lazy" />
                    </div>
                </div>
            @empty
