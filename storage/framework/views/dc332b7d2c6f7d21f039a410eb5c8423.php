<section class="py-10" id="directives">
    <div class=" mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $directives; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $directive): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white p-6 rounded-xl shadow-md text-center hover:shadow-lg transition">
                    <!--[if BLOCK]><![endif]--><?php if($directive->icon): ?>
...
<?php /**PATH C:\Users\Rygss\Downloads\smile-organization - Copy\resources\views/livewire/directives-section.blade.php ENDPATH**/ ?>