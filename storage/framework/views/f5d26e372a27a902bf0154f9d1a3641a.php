    ...
    <div class="max-w-7xl mx-auto" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="container py-12 mx-auto">
            <div id="whyUsGrid" class="flex flex-wrap text-center md:text-left justify-center">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $whyUsItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="p-4 md:w-1/4 sm:w-1/2">
                        <div class="px-4 py-6 transform transition duration-500 hover:scale-110">
                            <div class="flex justify-center">
                                <img src="<?php echo e(asset('storage/' . $item->image_url)); ?>" class="w-32 mb-3" alt="<?php echo e($item->title); ?>">
                            </div>
...
<?php /**PATH C:\Users\Rygss\Downloads\smile-organization\resources\views/livewire/why-us-section.blade.php ENDPATH**/ ?>